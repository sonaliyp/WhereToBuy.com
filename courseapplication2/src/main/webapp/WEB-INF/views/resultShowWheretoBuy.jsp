	...
	<div class="container" id="main">
		...
		<div class="bs-example">
					<img id="imgspace" src="${context}/resources/images/bestbuyMove.png" width="100"
						height="90" alt="bestbuy" /> &nbsp; &nbsp; &nbsp; &nbsp;
						<a href="http://www.bestbuy.com" class="btn btn-primary" target=_blank >Click to BestBuy</a>
		...
		<!-- table -->
			<img id="imgspace" src="${context}/resources/images/EBay_logo.svg.png" width="100"
						height="90" alt="ebay" hspace="100" />	
						<a href="http://www.ebay.com" class="btn btn-primary" target=_blank >Click to ebay</a>	
			<table class="table table-hover">
				<thead>
					<tr>
						<th>Product</th>
				...
				<tbody>
					<c:forEach items="${productsEbay}" var="product1">
						<tr>
							<td><c:out value="${product1.name}" /></td>
							<td><c:out value="${product1.title}" /></td>
							<td><c:out value="${product1.itemId}" /></td>
							<td><c:out value="${product1.currentPrice}" /></td>
							<td><c:out value="${product1.listingType}" /></td>
